...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'product_nomenclature' => 'required|string|max:20|unique:products,product_nomenclature,' . $productId . '',
            'product_name' => 'required|string|max:55|regex:/^[a-zA-ZñÑáéíóúÁÉÍÓÚ0-9 ,.\s]+$/|unique:products,product_name,' . $productId . '',
    ...
    public function messages(): array
    {
        return [
            ...
            'product_image.*' => 'La imagen debe ser una imagen válida.',
        ];
    }
}
