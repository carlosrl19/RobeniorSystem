    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white fw-bold">
                <p class="modal-title" id="staticBackdropLabel">Eliminar usuario</p>
            </div>
            <form action="{{ route('categories.destroy', $user->id) }}"
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            Está a punto de realizar una acción irreversible. ¿Realmente desea eliminar la categoría <strong style="text-transform: uppercase">{{ $user->name }}</strong>?
                        </div>
                    </div>
                </div>
