@php
$products_fornitures = App\Models\Products::where('category_id', 3)->get();
@endphp
<div class="card" style="width: 100%">
    <div class="card-body">
        <table id="fornitures_index_table" class="display table table-bordered">
            <thead>
            ...
            <tbody style="font-size: clamp(0.6rem, 3vw, 0.7rem) !important">
                @foreach ($products_fornitures as $product)
                <tr>
                    ...
                    <td>
                        ...
                        <div class="d-flex flex-wrap justify-content-center">
                            ...
                            <div class="mx-1">
                                <a class="forniture_image" data-gall="forniture_gallery" title="Mobiliario #{{ $product->product_code }} - {{ $product->product_nomenclature }}" data-fitview="true" href="uploads/products/{{ $image }}">
